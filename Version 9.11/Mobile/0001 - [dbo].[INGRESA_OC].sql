  ...
  IF @NRO_REG_CONTENEDORAS>0
    BEGIN
     ...
     BEGIN
      ...
      --Aca debo prorratear las contenedoras.
      ...
      VALUES(@doc_id, @Nrolinea , @cliente_id , @producto_id , @cantidad , NULL   , @cat_log_id  , '0'  , NULL   , @NRO_PARTIDA , @unidad_id , @descripcion , '1'    , '1'  ,@cantidad   , @nro_pallet ,@dext , @NROBULTO  , @NRO_LOTE)
