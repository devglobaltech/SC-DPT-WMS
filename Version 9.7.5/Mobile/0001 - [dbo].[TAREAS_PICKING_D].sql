...
AS
	...
	IF @TQUERY='1' BEGIN--Por aca pase y termine
			...
			GROUP BY	
					...
					CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 1 END) ELSE 1 END AS INT),
			...
			ORDER BY
					...
					CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 1 END) ELSE 1 END AS INT) DESC,
	...
	ELSE
		BEGIN
			IF @TQUERY='2'
				...
				ORDER BY	SP.RUTA,CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 1 END) ELSE 1 END AS INT)  DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID
					...
					IF @TQUERY='3'
						BEGIN
							...
							GROUP BY	SP.VIAJE_ID, SP.PRODUCTO_ID, SP.DESCRIPCION, SP.RUTA,SP.POSICION_COD, 
										CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 1 END) ELSE 1 END AS INT), SP.PROP1,
