...
AS
	...
	IF @TQUERY='1' BEGIN--Por aca pase y termine
			...
			SELECT 	TOP 1
					...
					@QTY=SUM(SP.CANTIDAD),@POSICION_COD= SP.POSICION_COD,@PALLET=SP.PROP1,@RUTA='9999',
					--@RUTA=SP.RUTA,
			...
			GROUP BY	
					SP.VIAJE_ID, SP.PRODUCTO_ID,SP.DESCRIPCION, 
					--SP.RUTA,
			...
			ORDER BY
					...
					CAST(ISNULL(SP.TIPO_CAJA,0) AS NUMERIC(10,1)) DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID
			...
			WHERE  	LTRIM(RTRIM(UPPER(VIAJE_ID)))=LTRIM(RTRIM(UPPER(@VIAJEID )))
					...
					AND ((ISNULL(@NRO_PARTIDA,'1') IS NULL) OR (ISNULL(DD.NRO_PARTIDA,'1')=ISNULL(@NRO_PARTIDA,'1')))
	...
	ELSE
		BEGIN
			IF @TQUERY='2'
				...
				GROUP BY	SP.VIAJE_ID, SP.PRODUCTO_ID,SP.DESCRIPCION
							--, SP.RUTA
							...
							,DD.NRO_LOTE, DD.NRO_PARTIDA, DD.NRO_SERIE
				ORDER BY	--SP.RUTA,
							CAST(SP.TIPO_CAJA AS NUMERIC(10,1)) DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID
