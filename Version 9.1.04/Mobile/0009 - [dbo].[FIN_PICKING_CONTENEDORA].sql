IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FIN_PICKING_CONTENEDORA]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[FIN_PICKING_CONTENEDORA]
GO
