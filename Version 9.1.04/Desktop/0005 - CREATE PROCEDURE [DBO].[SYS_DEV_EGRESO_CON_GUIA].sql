...
/****** Object:  StoredProcedure [dbo].[SYS_DEV_EGRESO_CON_GUIA]    Script Date: 12/19/2013 12:04:29 ******/
...
--INSERTO CABECERA    
	...
	SELECT	DISTINCT       
			...
			SID.AGENTE_ID, --?      
			ISNULL(@PESO_TOTAL, DBO.GET_PESO_TOTAL(P.CLIENTE_ID,P.VIAJE_ID)), --PESO_TOTAL,       
			SID.UNIDAD_PESO,       
			SID.VOLUMEN_TOTAL,       
			SID.UNIDAD_VOLUMEN,       
			DBO.GET_CANT_BULTOS(P.CLIENTE_ID,P.VIAJE_ID),
			SID.ORDEN_DE_COMPRA,       
			SID.OBSERVACIONES,       
