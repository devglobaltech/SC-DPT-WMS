...
/****** Object:  StoredProcedure [dbo].[RPT_OCUP_DEP]    Script Date: 02/10/2014 11:42:52 ******/
...
FROM
	...
	(
		...
		GROUP BY 	SE.F_SNAP, N.NAVE_COD,SE.POSICION_ACTUAL		
		) W
	GROUP BY  W.FECHA, W.NAVE_COD			
	...
	WHERE	DISPONIBLE = '1'
			...
			AND ((@FDESDE IS NULL)OR (DBO.TRUNC(SE.F_SNAP) BETWEEN @FDESDE AND @FHASTA))							
	GROUP BY 	SE.F_SNAP, N.NAVE_COD,SE.NAVE_ACTUAL		
	) W
	GROUP BY  W.FECHA, W.NAVE_COD	
