/****** Object:  StoredProcedure [dbo].[ABAST_MOB_TAREAS]    Script Date: 05/22/2015 15:23:11 ******/
...
BEGIN	
	...
	IF @CONTROL=0 BEGIN
		...
		SELECT  TOP 1
				...
				@CANT_A_REPONER	=DBO.ABAST_CONTROL_VOL_PESO((R.OCUPACION_MAX-ISNULL(X.QTY_POS,0)),R.CLIENTE_ID,R.PRODUCTO_ID,R.POSICION_ID) 
