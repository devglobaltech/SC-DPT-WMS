/****** Object:  StoredProcedure [dbo].[EMPAQUE_PRINT_ETIQUETA]    Script Date: 04/22/2015 17:03:49 ******/
...
BEGIN
	...
	GROUP BY
			...
			,T.TRANSPORTE_ID, T.NOMBRE, s.CALLE,s.NUMERO, s.LOCALIDAD, U.NRO_GUIA,D.CLIENTE_ID,U.OBSERVACIONES
END
