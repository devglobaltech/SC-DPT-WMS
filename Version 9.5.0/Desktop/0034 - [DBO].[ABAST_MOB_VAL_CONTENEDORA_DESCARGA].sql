...
IF  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[ABAST_MOB_VAL_CONTENEDORA_DESCARGA]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [DBO].[ABAST_MOB_VAL_CONTENEDORA_DESCARGA]
GO

CREATE PROCEDURE [DBO].[ABAST_MOB_VAL_CONTENEDORA_DESCARGA]
