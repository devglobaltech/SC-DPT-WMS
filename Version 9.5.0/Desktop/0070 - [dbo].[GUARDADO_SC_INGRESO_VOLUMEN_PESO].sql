/****** Object:  UserDefinedFunction [dbo].[GUARDADO_SC_INGRESO_VOLUMEN_PESO]    Script Date: 06/03/2015 17:25:35 ******/
...
BEGIN
	...
	DECLARE @VOL_ISZERO		NUMERIC(10,0)
	...
	SELECT	@POS_VOLUMEN	=(ISNULL(ALTO,0) * ISNULL(ANCHO,0) * ISNULL(LARGO,0))/1000000,
			...
			@POS_PESO		=CASE ISNULL(PESO,0) WHEN 0 THEN 1000000 ELSE PESO END ,
	...
	IF @PROD_VOLUMEN=0 AND @PESO_UN=0
	BEGIN
		RETURN @CANTIDAD
	END		
	...
	IF ISNULL(@POS_PESO,0)>0 AND ISNULL(@STK_PESO,0)>0
	BEGIN
