/****** Object:  StoredProcedure [dbo].[RPTHojadeCarga]    Script Date: 04/24/2015 17:27:58 ******/
...
begin 
		select	U.NRO_HOJACARGA      
				...
				,(isnull(U.ALTO,0)*isnull(U.ANCHO,0)*isnull(U.LARGO,0))/1000000 as VOLUMEN
		...
		GROUP BY
				...
				,isnull(U.ALTO,0),isnull(U.ANCHO,0),isnull(U.LARGO,0),U.OBS_HOJA_CARGA,U.OBSERVACIONES	
		ORDER BY
