...
/****** Object:  StoredProcedure [dbo].[SetHojadeCarga]    Script Date: 04/23/2015 11:53:02 ******/
...
@OBS_HOJA_CARGA VARCHAR(200) OUTPUT                 
 ...
 */            
 ...
 UPDATE UC_EMPAQUE SET NRO_HOJACARGA = @hojacarga, FECHA_HOJACARGA = GETDATE(), OBS_HOJA_CARGA=@OBS_HOJA_CARGA WHERE NRO_GUIA IN (SELECT A COLLATE Latin1_General_CI_AS FROM #TBL)                           
