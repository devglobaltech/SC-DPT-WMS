...
/****** Object:  StoredProcedure [dbo].[INGRESO_OC_ALTA]    Script Date: 07/13/2015 16:13:32 ******/
...
BEGIN
	...
	WHILE @@FETCH_STATUS=0 BEGIN
		...
		IF @VCANTIDAD>=@QTY_LIN BEGIN 
			...
			INSERT INTO INGRESO_OC(CLIENTE_ID, PRODUCTO_ID, ORDEN_COMPRA, CANTIDAD, CANT_CONTENEDORAS, USUARIO, TERMINAL, FECHA, PROCESADO, NRO_LOTE, NRO_PARTIDA, DOC_EXT, FECHA_VTO)                    
			VALUES                (@CLIENTE_ID,@PRODUCTO_ID,@ORDEN_COMPRA,@QTY_LIN,@CANT_CONTENEDORAS,@USUARIO,@TERMINAL,@FECHA,@PROCESADO, @LOTEPROVEEDOR, @PARTIDA, @VDOCEXT, @FECHA_VTO);
		...
		ELSE BEGIN
			...
			INSERT INTO INGRESO_OC(CLIENTE_ID, PRODUCTO_ID, ORDEN_COMPRA, CANTIDAD, CANT_CONTENEDORAS, USUARIO, TERMINAL, FECHA, PROCESADO, NRO_LOTE, NRO_PARTIDA, DOC_EXT, FECHA_VTO)                    
			VALUES                (@CLIENTE_ID,@PRODUCTO_ID,@ORDEN_COMPRA,@VCANTIDAD,@CANT_CONTENEDORAS,@USUARIO,@TERMINAL,@FECHA,@PROCESADO, @LOTEPROVEEDOR, @PARTIDA, @VDOCEXT, @FECHA_VTO);
