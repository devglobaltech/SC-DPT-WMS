  ...
  IF @NRO_REG_CONTENEDORAS>0
    BEGIN
     ...
     BEGIN
      ...
      VALUES(@doc_id, @Nrolinea , @cliente_id , @producto_id , @cantidad , NULL   , @cat_log_id  , '0'  , NULL   , @VPARTIDA , @unidad_id , @descripcion , '1'    , '1'  ,@cantidad   , @nro_pallet ,@dext , @NROBULTO  , @NRO_LOTE, @NRO_DESPACHO, @EST_MERC_ID)
  ...
  ELSE
   BEGIN
    ...
    if @cntdd<>@CntIng begin 
      ...
      INSERT INTO det_documento (documento_id, nro_linea , cliente_id , producto_id , cantidad , cat_log_id , cat_log_id_final , tie_in , fecha_vencimiento , nro_partida , unidad_id  , descripcion , busc_individual , item_ok , cant_solicitada , prop1 , prop2, nro_bulto ,nro_lote, NRO_DESPACHO, EST_MERC_ID)
      VALUES(@doc_id, @Nrolinea , @cliente_id , @producto_id , @cantidad , NULL   , @cat_log_id  , '0'  , NULL   , @VPARTIDA , @unidad_id , @descripcion , '1'    , '1'  ,@qtyBO   , @nro_pallet ,@DOC_EXT , NULL  , @NRO_LOTE, @NRO_DESPACHO, @EST_MERC_ID)
