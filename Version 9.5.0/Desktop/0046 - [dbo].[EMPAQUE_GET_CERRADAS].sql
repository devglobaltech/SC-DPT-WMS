/****** Object:  StoredProcedure [dbo].[EMPAQUE_GET_CERRADAS]    Script Date: 04/22/2015 17:23:04 ******/
...
BEGIN          
	SELECT	DISTINCT          
			...
			U.OBSERVACIONES AS [Observaciones]
	...
	GROUP BY          
			...
			U.ALTO, U.ANCHO, U.LARGO ,u.NRO_GUIA, U.OBSERVACIONES      
END
