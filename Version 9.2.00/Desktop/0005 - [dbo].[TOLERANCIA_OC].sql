/****** Object:  StoredProcedure [dbo].[TOLERANCIA_OC]    Script Date: 06/16/2014 16:54:52 ******/
...
BEGIN
	...
	set @ToleranciaMax= (@qtyBO - @CANTIDADINGRESADA) + (((@qtyBO - @CANTIDADINGRESADA) * @ToleranciaMax)/100)  
	set @ToleranciaMin= (@qtyBO - @CANTIDADINGRESADA) - (((@qtyBO - @CANTIDADINGRESADA) * @ToleranciaMin)/100)
