/****** Object:  StoredProcedure [dbo].[CerrarProductoEnContenedora]    Script Date: 04/22/2016 16:53:31 ******/
...
BEGIN
	...
	BEGIN
		...
		select	DOCUMENTO_ID,
				...
				PALLET_CERRADO,
				@USUARIO_EMPAQUE, --USUARIO_PF
				@TERMINAL_EMPAQUE, --TERMINAL_PF
				REMITO_IMPRESO,
				NRO_REMITO_PF,
				PICKING_ID_REF,
				BULTOS_CONTROLADOS,
