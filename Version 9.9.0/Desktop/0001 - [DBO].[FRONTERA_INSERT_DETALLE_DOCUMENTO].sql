IF  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[FRONTERA_INSERT_DETALLE_DOCUMENTO]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [DBO].[FRONTERA_INSERT_DETALLE_DOCUMENTO]
GO

CREATE PROCEDURE [DBO].[FRONTERA_INSERT_DETALLE_DOCUMENTO]
...
BEGIN
	...
	*/
	...
	SELECT	@pDOCUMENTO_ID						DOCUMENTO_ID,
			...
			SDD.CAT_LOG_ID						CAT_LOG_ID,
			SDD.EST_MERC_ID						EST_MERC_ID
