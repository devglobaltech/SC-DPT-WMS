...
/****** Object:  StoredProcedure [dbo].[Actualiza_Det_documento_Historicos]    Script Date: 10/10/2014 16:19:59 ******/
		...
		Begin
			...
			Begin
				...
				select 	 top 1
						...
						,nro_linea_trans
						,NULL
						,CASE WHEN NAVE_ANTERIOR = '2' THEN POSICION_ACTUAL ELSE POSICION_ANTERIOR END
						,@Diferencia as cantidad
						,tipo_movimiento_id
						,Ultima_estacion
						,Ultima_Secuencia
						,1
						,CASE WHEN NAVE_ANTERIOR = '2' THEN NAVE_ACTUAL ELSE NAVE_ANTERIOR END
						,documento_id
						,nro_linea
						,1
						,null as doc_trans_id_egr
