...
BEGIN
	...
	*/
	...
	insert into det_documento (documento_id, nro_linea	, cliente_id	, producto_id	, cantidad	, cat_log_id	, cat_log_id_final	, tie_in	, fecha_vencimiento	, nro_partida	, unidad_id	, descripcion		, busc_individual	, item_ok	, cant_solicitada	, prop1	, prop2		, nro_bulto	,nro_lote, NRO_DESPACHO)
					       values(@doc_id		, 1			, @cliente_id	, @producto_id	, @qty		, null		, @cat_log_id		, '0'		, @fecha_vto		, @nro_partida	, @unidad_id	, @descripcion	, '1'				, '1'			,@qtyBO			, @pallet, UPPER(@loteProv)	, NULL		, @lote_at, @NRO_DESPACHO)
