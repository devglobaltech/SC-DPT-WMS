...
/****** Object:  StoredProcedure [dbo].[Funciones_Estacion_Api#Obtener_Rl_Id_Documento]    Script Date: 10/14/2014 14:46:01 ******/
...
Begin
	...
	If (@P_Opcion = 1 or @P_Opcion = 2 or @P_Opcion = 3 or @P_Opcion = 4 or @P_Opcion = 5)
		Begin
			Set @Msg1 = @Msg1 + 'order by rl.cantidad desc' + Char(13)
		End 
