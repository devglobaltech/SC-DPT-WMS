/****** Object:  StoredProcedure [dbo].[SetHojadeCarga]    Script Date: 10/07/2013 16:59:47 ******/
 ...
 */            
 ...
 BEGIN                     
   ...
   --UPDATE PICKING SET VIAJE_ID = @HOJACARGA WHERE VIAJE_ID = @VIAJE AND CANT_CONFIRMADA = '0'
 FETCH NEXT FROM CURR INTO @UCEMPAQUE,@VIAJE                      
 END                      
 CLOSE CURR;                      
 DEALLOCATE CURR;                    
