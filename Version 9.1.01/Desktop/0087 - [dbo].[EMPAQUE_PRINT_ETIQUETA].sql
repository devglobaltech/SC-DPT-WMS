/****** Object:  StoredProcedure [dbo].[EMPAQUE_PRINT_ETIQUETA]    Script Date: 10/03/2013 15:24:13 ******/
...
BEGIN
 ...
 WHERE	
		U.NRO_GUIA = @guia
			--d.nro_remito in ('2011061443','2011061444','2011061440')
		 /*and 
		 EXISTS (SELECT 1
 ...
 GROUP BY
   ...
   ,T.TRANSPORTE_ID, T.NOMBRE, s.CALLE,s.NUMERO, s.LOCALIDAD, U.NRO_GUIA
