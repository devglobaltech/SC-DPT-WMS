/****** Object:  StoredProcedure [dbo].[INGRESA_PICKING]    Script Date: 09/16/2013 17:21:26 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[INGRESA_PICKING]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[INGRESA_PICKING]
GO
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
CREATE                         PROCEDURE [dbo].[INGRESA_PICKING]
