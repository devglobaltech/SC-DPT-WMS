/****** Object:  StoredProcedure [dbo].[Frontera_FinPicking]    Script Date: 10/16/2013 14:37:53 ******/
...
BEGIN
	...
	Where	p.fin_picking='2'
			...
			--and ((ISNULL(cp.flg_distribucion,'0')='0')or(isnull(p.ST_CONTROL_EXP,'0')=isnull(cp.FLG_CONTROL_EXP,'0')))			
	group by 
			p.viaje_id, x.cantidad_solicitada,c.razon_social
