/****** Object:  StoredProcedure [dbo].[RPT_MOVIMIENTOS_AUX1]    Script Date: 09/17/2013 16:11:23 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RPT_MOVIMIENTOS_AUX1]') AND type in (N'P', N'PC'))
