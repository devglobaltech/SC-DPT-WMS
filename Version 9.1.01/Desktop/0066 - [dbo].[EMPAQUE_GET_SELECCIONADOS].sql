/****** Object:  StoredProcedure [dbo].[EMPAQUE_GET_SELECCIONADOS]    Script Date: 09/26/2013 10:45:40 ******/
...
BEGIN        
	...
	FROM	PICKING P     
			...
			INNER JOIN SYS_INT_DOCUMENTO SD    
			ON D.NRO_REMITO = SD.DOC_EXT    
			LEFT JOIN TRANSPORTE T  
			ON SD.TRANSPORTE_ID = T.TRANSPORTE_ID   
 ...
 GROUP BY        
   d.documento_id,D.NRO_REMITO, P.NRO_UCDESCONSOLIDACION,D.SUCURSAL_DESTINO,D.CLIENTE_ID,SD.IMPORTE_FLETE, SD.TRANSPORTE_ID,t.nombre  
END
