/****** Object:  StoredProcedure [dbo].[VALIDACION_SERIE]    Script Date: 05/15/2014 16:09:57 ******/
	...
	*/
	...
	IF(@SERIE_ESP='1') BEGIN
		...
		IF LEN(@NRO_SERIE)=20 BEGIN
			...
			IF (@SKU <> @SKUD)AND((@2SKU<>'10')AND(@2SKU<>'20')AND(@2SKU<>'60')) BEGIN
				--LOS SKU NO PUEDEN SER DIFERENTES.
				SET @RETORNO='4';
				RETURN		
			END
						
			IF ((@2SKU='10')OR(@2SKU='20')OR(@2SKU='60'))BEGIN
