...
ALTER PROCEDURE DBO.MOB_CONFIRMA_SERIES_PALLET
...
BEGIN
	...
	UPDATE	PICKING
	SET		FECHA_INICIO=@FECHA_INICIO, FECHA_FIN=GETDATE(), USUARIO=@USUARIO,CANT_CONFIRMADA=CANTIDAD, 
			--PALLET_PICKING=@PALLET_PICK
			PALLET_PICKING=@PALLET
	WHERE	VIAJE_ID=@VIAJE_ID 
			AND POSICION_COD=@POSICION_COD
			AND PROP1=@PALLET
			--AND USUARIO=@USUARIO
