/****** Object:  StoredProcedure [dbo].[MOB_PICKING_DESCOMPONER_SERIE_ESPECIFICA]    Script Date: 05/29/2014 16:35:52 ******/
...
BEGIN
	...
	IF LEN(@NRO_SERIE)=20 BEGIN
		...
		IF (@SKUD='10')OR(@SKUD='20')OR(@SKUD='30') BEGIN
			IF (@SKU <> @SKUD)AND((@SKUD<>'10')AND(@SKUD<>'20')AND(@SKUD<>'60')) BEGIN
				--LOS SKU NO PUEDEN SER DIFERENTES.
				SET @ERROR='4';
				RETURN
			END
		END 
		IF ((@SKUD='10')OR(@SKUD='20')OR(@SKUD='60'))BEGIN
