/****** Object:  View [dbo].[view_web_stock_resumido]    Script Date: 12/10/2015 17:42:48 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[view_web_stock_resumido]'))
DROP VIEW [dbo].[view_web_stock_resumido]
GO

Create view [dbo].[view_web_stock_resumido]
As
...
GROUP  BY 
		t2.clienteid,				c.razon_social,				t2.productoid,			p.DESCRIPCION,
		t2.categlogid,				t2.est_merc_id,				t2.nro_lote,			t2.nro_partida, 
		t2.nro_serie,				t2.fecha_vencimiento,		t2.nro_despacho,		t2.prop3,
		f.DESCRIPCION,				sf.DESCRIPCION			        
GO
