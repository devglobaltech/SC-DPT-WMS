/****** Object:  StoredProcedure [dbo].[MOB_CERRAR_TMP_PRODUCTO_EMPAQUE]    Script Date: 11/13/2015 16:02:58 ******/
...
BEGIN
	...
	SELECT	DOCUMENTO_ID,NRO_LINEA,CLIENTE_ID,PRODUCTO_ID,VIAJE_ID,TIPO_CAJA,DESCRIPCION,CANTIDAD,NAVE_COD,POSICION_COD,
			...
			CASE PALLET_CONTROLADO WHEN '1' THEN USUARIO_PF ELSE NULL END,
			
			TERMINAL_PF,REMITO_IMPRESO,NRO_REMITO_PF,PICKING_ID_REF,
			
			CASE PALLET_CONTROLADO WHEN '1' THEN BULTOS_CONTROLADOS ELSE NULL END,
