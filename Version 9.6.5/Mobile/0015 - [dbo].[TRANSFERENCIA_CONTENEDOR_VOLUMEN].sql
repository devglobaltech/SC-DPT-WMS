...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TRANSFERENCIA_CONTENEDOR_VOLUMEN]') AND type in (N'FN'))
DROP FUNCTION [dbo].[TRANSFERENCIA_CONTENEDOR_VOLUMEN]
GO

CREATE FUNCTION [dbo].[TRANSFERENCIA_CONTENEDOR_VOLUMEN](
