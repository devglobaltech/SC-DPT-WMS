IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SOBRANTES_PICKING_FORZADO]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SOBRANTES_PICKING_FORZADO]
GO

CREATE PROCEDURE [dbo].[SOBRANTES_PICKING_FORZADO]
...
BEGIN
	...
	SET @MSG='TIPO: ' + CAST(@TIPO AS VARCHAR) + ', PALLET: ' + @PALLET +', CONT.: ' +@CONTENEDORA 
	PRINT (@MSG)
