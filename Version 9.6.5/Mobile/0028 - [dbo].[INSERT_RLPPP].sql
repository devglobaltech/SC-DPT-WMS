...
/****** Object:  StoredProcedure [dbo].[INSERT_RLPPP]    Script Date: 04/03/2016 11:49:20 ******/
...
Begin
	...
	End
	--Inserto en la tabla
	INSERT INTO RL_PRODUCTO_POSICION_PERMITIDA (CLIENTE_ID, PRODUCTO_ID, NAVE_ID, POSICION_ID, OCUPACION_MIN, OCUPACION_MAX, CANT_PALLET) 
	VALUES(@Cliente_id, @Producto_Id, @Nave_Id, @Posicion_id, @Ocupacion_Min, @Ocupacion_Max, @CANT_PALLET)
