/****** Object:  StoredProcedure [dbo].[PICKING_PENDIENTE]    Script Date: 01/28/2015 15:06:56 ******/
...
BEGIN
		...
		GROUP BY	SP.VIAJE_ID, SP.PRODUCTO_ID,SP.DESCRIPCION, 
					SP.RUTA,
					SP.POSICION_COD,SP.TIPO_CAJA,SP.PROP1,SP.PALLET_PICKING,PROD.UNIDAD_ID,PROD.VAL_COD_EGR, SP.HIJO,SP.CLIENTE_ID,
