...
/****** Object:  StoredProcedure [dbo].[TAREAS_PICKING]    Script Date: 01/28/2015 15:09:14 ******/
	...
	ELSE
		BEGIN
			IF @TQUERY='2'
				...
				ORDER BY	SP.TIPO_CAJA DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID,
							DD.PROP2
