...
/****** Object:  StoredProcedure [dbo].[Sys_Dev_Transferencia]    Script Date: 02/04/2015 10:32:23 ******/
...
Begin
	...
	---------------------------------------------------------	
	--Para ver si tiene mas de un cliente
	---------------------------------------------------------	
	Declare @CantCli		as Numeric(20,0)
	---------------------------------------------------------		
	...
	Begin 
		...
		Begin
			...
			select @CantCli=COUNT(*) from SYS_DEV_DOCUMENTO where DOC_EXT = 'TRANS-'+Cast(@Doc_Trans_id as varchar(20)) and CLIENTE_ID = @Cliente_id
