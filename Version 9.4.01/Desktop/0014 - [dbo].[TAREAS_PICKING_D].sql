...
/****** Object:  StoredProcedure [dbo].[TAREAS_PICKING_D]    Script Date: 01/28/2015 15:09:49 ******/
...
AS
	...
	IF @TQUERY='1' BEGIN--Por aca pase y termine
			...
			ORDER BY
					SPV.PRIORIDAD ASC,SP.RUTA, SP.TIPO_CAJA DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID
		...
		BEGIN
			IF @TQUERY='2'
				...
				GROUP BY	SP.VIAJE_ID, SP.PRODUCTO_ID,SP.DESCRIPCION, SP.RUTA
							...
							,CASE WHEN CP.FLG_SOLICITA_LOTE='1' THEN ISNULL(DD.PROP2,NULL) ELSE NULL END,SP.NRO_SERIE,DD.NRO_BULTO
							,DD.NRO_LOTE, DD.NRO_PARTIDA, DD.NRO_SERIE
				ORDER BY	SP.RUTA,SP.TIPO_CAJA DESC,POS.ORDEN_PICKING, SP.POSICION_COD ASC, SP.PRODUCTO_ID
