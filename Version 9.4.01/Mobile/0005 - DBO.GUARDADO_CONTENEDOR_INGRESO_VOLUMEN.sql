...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GUARDADO_CONTENEDOR_INGRESO_VOLUMEN]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[GUARDADO_CONTENEDOR_INGRESO_VOLUMEN]
GO

--DROP FUNCTION DBO.GUARDADO_CONTENEDOR_INGRESO_VOLUMEN
CREATE FUNCTION [dbo].[GUARDADO_CONTENEDOR_INGRESO_VOLUMEN](
