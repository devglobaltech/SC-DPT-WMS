...
AS
	...
	IF @TQUERY='1' BEGIN--Por aca pase y termine
			...
			GROUP BY	
					...
					CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 9999 END) ELSE 9999 END AS INT),
			...
			ORDER BY
					...
					CAST(CASE ISNULL(CP.FLG_RECORRIDO_PALLET_FINAL,'0')	WHEN '1' THEN (CASE ISNUMERIC(SP.TIPO_CAJA) WHEN 1 THEN SP.TIPO_CAJA ELSE 9999 END) ELSE 9999 END AS INT) ASC,
