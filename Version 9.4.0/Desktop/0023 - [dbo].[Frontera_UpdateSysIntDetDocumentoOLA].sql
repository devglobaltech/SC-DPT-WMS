...
/****** Object:  StoredProcedure [dbo].[Frontera_UpdateSysIntDetDocumentoOLA]    Script Date: 12/22/2014 15:27:49 ******/
	...
	BEGIN
		...
		if (@Qty=0) begin --significa que no quedan pendientes de procesar
			...
			if (@QtyProc=0) begin
				...
				exec dbo.SYS_DEV_EGRESO_PEDIDO @CLIENTE_ID, @pdoc_ext
			end --if
		end --if
