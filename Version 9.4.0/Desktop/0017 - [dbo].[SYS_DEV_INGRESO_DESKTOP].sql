/****** Object:  StoredProcedure [dbo].[SYS_DEV_INGRESO_DESKTOP]    Script Date: 12/16/2014 12:56:59 ******/
...
BEGIN
    ...
    if @e_sp='1' begin        
		...
		SELECT	@cliente_id=CLIENTE_ID,@TempDocumento_id= D.TIPO_COMPROBANTE_ID + '-' + CAST(D.DOCUMENTO_ID AS VARCHAR(100))
		FROM	DOCUMENTO D
		WHERE	DOCUMENTO_ID=@DOCUMENTO_ID
