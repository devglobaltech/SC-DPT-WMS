/****** Object:  StoredProcedure [dbo].[LocatorEgreso_GARANTIAS]    Script Date: 11/26/2014 17:04:38 ******/
		...
		Set @RsExist = Cursor For      
		  ...
		  from (    SELECT  dd.fecha_vencimiento      
				...
				WHERE	rl.doc_trans_id_egr is null
						...
						and exists (select 1 from nave n2 where n2.FLG_GARANTIA = '1' and n2.nave_id = P.nave_id )--'8'      
