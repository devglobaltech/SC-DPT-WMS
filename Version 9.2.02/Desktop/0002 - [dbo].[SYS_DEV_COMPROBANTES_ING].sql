/****** Object:  StoredProcedure [dbo].[SYS_DEV_COMPROBANTES_ING]    Script Date: 07/10/2014 13:02:08 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SYS_DEV_COMPROBANTES_ING]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SYS_DEV_COMPROBANTES_ING]
GO

CREATE         PROCEDURE [dbo].[SYS_DEV_COMPROBANTES_ING]
