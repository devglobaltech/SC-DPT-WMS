/****** Object:  StoredProcedure [dbo].[LocatorEgreso_OLA]    Script Date: 08/08/2014 13:20:45 ******/
				...
				Begin	
					...
					begin   
						...
						begin
							...
							SELECT @Asignado=SUM(CANTIDAD) FROM det_documento_aux WHERE DOCUMENTO_ID=@pDocumento_id
