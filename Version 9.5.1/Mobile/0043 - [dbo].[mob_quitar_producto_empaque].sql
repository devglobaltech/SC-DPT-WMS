/****** Object:  StoredProcedure [dbo].[mob_quitar_producto_empaque]    Script Date: 09/22/2015 18:07:54 ******/
...
BEGIN
		...
		IF (@CANT_CONTROLADA > @CANT_AUX)
			...
			FETCH NEXT FROM @CUR INTO @PICKID,@CANT
				...
				ELSE
					...
					UPDATE PICKING SET PALLET_CONTROLADO = '0', BULTOS_CONTROLADOS=null, NRO_UCEMPAQUETADO=null WHERE PICKING_ID=@PICKID
	...
	ELSE
	BEGIN
		UPDATE PICKING SET PALLET_CONTROLADO = '0', BULTOS_CONTROLADOS=NULL, NRO_UCEMPAQUETADO=NULL WHERE PICKING_ID = @P_PICKING_ID;
	END
END
