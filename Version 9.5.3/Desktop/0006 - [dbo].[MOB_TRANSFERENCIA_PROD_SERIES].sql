/****** Object:  StoredProcedure [dbo].[MOB_TRANSFERENCIA_PROD_SERIES]    Script Date: 11/06/2015 11:04:44 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MOB_TRANSFERENCIA_PROD_SERIES]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[MOB_TRANSFERENCIA_PROD_SERIES]
GO

CREATE PROCEDURE [dbo].[MOB_TRANSFERENCIA_PROD_SERIES]
